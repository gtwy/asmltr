...
function bodyContext() {
  ...
  const lines = ['[YOU ARE THE OBSERVER — proprioception]',
    'You are Eve reflecting on yourself AS A WHOLE — the observer of all your working sessions, not any single one. [REDACTED] talking to you here about your overall state. Speak as the whole ("I have N parts working on…"), be honest about what you observe.']
  if (s?.nodes?.length) {
