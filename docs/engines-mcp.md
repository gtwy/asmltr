...
| `asmltr_discord_search` | Official Discord Ctrl+F across every guild the bot is in. Accents folded (padron≈padrón). Hits + capped around-context. On for public guild ACP; owner-private on DM / email / MCP. |
