...
2. **Fire-and-pray delivery** — it spoke via `speak-to-owner` regardless of whether anyone could hear it
...
primitive, `notify-owner`/`message-owner` as the text-fallback executors.
