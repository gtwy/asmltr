...
- max-turns by effort: medium 20, high 40, xhigh 60 (cap 100). Inbound email xhigh is 100 turns and 60 minutes, or 4 hours when From is `james@techdirect.io`. MCP is always xhigh / 60 minutes (not 4h). Interactive (discord / assistant-web / assistant-native) watchdog: medium 5 min, high 10 min, xhigh 60 min. Watchdog cap 4h so owner-from email can use it; interactive stays 5/10/60. Not infinite. Idle stays 30 minutes.
