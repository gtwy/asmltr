...
- max-turns by effort: medium 20, high 40, xhigh 60 (cap 100). Inbound email xhigh is 100 turns and 60 minutes, or 4 hours when From is `james@techdirect.io`. Interactive (discord / assistant-web / assistant-native / mcp) watchdog: medium 5 min, high 10 min, xhigh 15 min. Watchdog cap 4h so owner-from email can use it; interactive stays 5/10/15. Not infinite. Idle stays 30 minutes.
